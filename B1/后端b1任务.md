...
2. 了解HTTP协议，知道其流程以及get, post, put, delete等动词
...
首先，规定一下留言的数据结构，一个留言需要包含一下内容：
	...
	字段名		类型		描述
	id			Fixnum	留言的ID，由系统发放，应当是一个自增的值，比如原来的最大id为n,那么下一条添加的记录就应该是n+1
